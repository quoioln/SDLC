...
4. **Auto-trigger the next phase** unless the user intervened: run `/sdlc-workflow:architect` and print its role banner. Do not idle — the pipeline runs continuously unless told to stop.
